...
namespace BiliLiveDanmaku.Modules
{
    ...
    /// </summary>
    public partial class DanmakuSpeechControl : UserControl
    {
        private DanmakuSpeechModule Module { get; set; }
        ...
        private void ShowOptionCkb_Checked(object sender, RoutedEventArgs e)
        {
            ...
            DanmakuSpeechConfig.SpeechFilterOptions filterOptions = (DanmakuSpeechConfig.SpeechFilterOptions)checkBox.Tag;
